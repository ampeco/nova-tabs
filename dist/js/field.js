  ...
  computed: {
    activeTabHasSearch: function activeTabHasSearch() {
      ...
      _.forEach(tab.fields, function (field) {
        ...
        if (field.component == "has-many-field" || field.component == "has-oney-field" || field.component == "belongs-to-field" || field.component == "belongs-to-many-field" || field.component == "morph-many-field" || field.component == "morph-to-field" || field.component == "morph-to-many-field") {
          hasTab = true;
        }
      });
